...
export default function FilterButton({ label, current, onClick}) {
  return (
    <button onClick={onClick} className="text-lg md:text-[2vw] xl:text-[2vw] 2xl:text-[1.8vw] leading-none md:leading-none xl:leading-none 2xl:leading-none font-sans uppercase flex items-center overflow-hidden group">
