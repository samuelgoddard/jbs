            ...
            <div className="block overflow-hidden w-full">
              ...
              <AnimatePresence initial={false}>
                <span className="block overflow-hidden relative w-full">
                  <h1 className="text-5xl md:text-[6.5vw] xl:text-[7vw] 2xl:text-[7.5vw] leading-[1.12] md:leading-[1.12] xl:leading-[1.12] 2xl:leading-[1.12] font-sans uppercase mb-[-5px] md:mb-[-1vw] relative overflow-hidden block w-full ml-[-0.075vw]">
                    {work.map((e, i) => {
                      return i == current ? (
                        <m.span
                          key={i}
