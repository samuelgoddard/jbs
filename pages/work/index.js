          ...
          <div data-scroll-section>
            <LazyMotion features={domAnimation}>
              <m.div
                ...
                id="sticky"
              >
                <m.main className="grid grid-cols-9">
                  <div className="fixed top-0 left-0 w-[66.75vw]" data-scroll data-scroll-sticky data-scroll-target="#sticky">
                    <div className="h-screen flex flex-col flex-wrap relative p-3">
                      ...
                      <div className="w-full flex-1">
                        ...
                        <div className="w-full grid grid-cols-5">
                          <div className="col-span-1">
                            <span className="block leading-none text-sm">JBS.06</span>
                          </div>
                          <div className="col-span-1">
                            <span className="block leading-none text-sm">Bacardi</span>
                          </div>
                          <div className="col-span-1">
                      ...
                      <div className="w-full flex items-end">
                        <div className="w-[33px] md:w-[48px]">
                        ...
                        <h1 className="text-5xl md:text-[6.5vw] xl:text-[7vw] 2xl:text-[7.5vw] leading-none md:leading-none xl:leading-none 2xl:leading-none font-sans uppercase mb-[-5px] md:mb-[-0.78vw] ml-2 md:ml-8">Bacardi</h1>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-span-3 col-start-7 p-3 pl-0 -mt-8 flex justify-center">
                    <div className="w-9/12">
                      {work.map((e, i) => {
                        ...
                        return (
                          <li className={`block mb-16 ${width}`} key={i}>
                            { e.images && (
                              <div>
                                <Image
                                  image={e.images[0]}
